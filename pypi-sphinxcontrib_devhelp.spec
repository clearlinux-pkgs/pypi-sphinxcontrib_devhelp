...
%prep
%setup -q -n sphinxcontrib_devhelp-1.0.5
cd %{_builddir}/sphinxcontrib_devhelp-1.0.5
pushd ..
cp -a sphinxcontrib_devhelp-1.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692059663
