...
Source0  : https://files.pythonhosted.org/packages/c7/a1/80b7e9f677abc673cb9320bf255ad4e08931ccbc2e66bde4b59bad3809ad/sphinxcontrib_devhelp-1.0.6.tar.gz
...
%prep
%setup -q -n sphinxcontrib_devhelp-1.0.6
cd %{_builddir}/sphinxcontrib_devhelp-1.0.6
pushd ..
cp -a sphinxcontrib_devhelp-1.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705166159
...
cp %{_builddir}/sphinxcontrib_devhelp-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-sphinxcontrib_devhelp/7ff1f231e0b27a80eb835961e888560c43a649ca || :
